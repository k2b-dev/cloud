...
Filesv2 uses the separate Filegate v6 root and lease API; see
[Filesv2](/en/apps/filesv2). The local development daemon is v6 and cannot serve
the older Files app.
