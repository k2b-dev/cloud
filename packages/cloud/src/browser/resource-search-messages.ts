...
export const resourceSearchMessages = i18n.define({
  ...
  messages: {
    en: {
      ...
      commandUnavailable: "This action is no longer available. Choose another action.",
      ...
      scopedSearchPlaceholder: "Search…",
    ...
    de: {
      ...
      commandUnavailable: "Diese Aktion ist nicht mehr verfügbar. Wähle eine andere Aktion.",
      ...
      scopedSearchPlaceholder: "Durchsuchen…",
