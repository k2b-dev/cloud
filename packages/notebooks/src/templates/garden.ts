...
export const gardenPlannerTemplate: NotebookTemplate = {
  ...
  notebookDescription: "Plants, beds, harvests, and an automatic index of garden pages.",
  translations: {
    de: {
      name: "Gartentagebuch",
      description: "Aussaatzeiten, Beete, Ernten und saisonale Gartenarbeiten.",
      notebookName: "Gartentagebuch",
      notebookDescription: "Pflanzen, Beete und Ernten mit einem automatischen Verzeichnis der Gartenseiten.",
    },
  },
...
:::success
Start here. Keep planting dates, bed plans, and harvests in readable tables. The index below links your garden pages.
:::
...
3. Record real harvests in ${c.link("harvest", "Harvest")}.
4. Add short tasks below when something needs attention this week.
