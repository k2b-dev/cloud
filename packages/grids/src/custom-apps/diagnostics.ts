          ...
          (
            {
              ...
              "document_template.preview_invalid":
                "Document preview requires an enabled template. Its GQL source may interpolate only {{ record.id }} or {{ record.shortId }}, not field values or other Liquid expressions.",
              ...
              "metrics.aggregate_required":
                "The Metrics source must return ungrouped scalar aggregations or explicitly select numeric columns with limit 1.",
              "metrics.aggregation_limit": "The Metrics source may return at most 12 values.",
          ...
          (
            {
              ...
              "document_template.preview_invalid":
                "Die Dokumentvorschau benötigt eine aktivierte Vorlage. Ihre GQL-Quelle darf nur {{ record.id }} oder {{ record.shortId }} einsetzen, keine Feldwerte oder anderen Liquid-Ausdrücke.",
              ...
              "metrics.aggregate_required":
                "Die Quelle des Kennzahlenblocks muss ungruppierte skalare Aggregationen oder explizit ausgewählte numerische Spalten mit limit 1 zurückgeben.",
              "metrics.aggregation_limit": "Die Quelle des Kennzahlenblocks darf höchstens zwölf Werte zurückgeben.",
