...
Speichern prüft die aktuellen Versionen und übernimmt Eltern- und Kindänderungen gemeinsam. Bei Verbindungsfehlern den Dialog offen lassen und denselben Versuch wiederholen. Nach einem bestätigten Versionskonflikt aktuelle Werte neu laden und prüfen, statt fremde Änderungen zu überschreiben. CLI/API-Aufrufe benötigen explizite Versionen und einen stabilen Idempotenzschlüssel. Payload und Grenzen stehen in der [Custom-App-API-Referenz](/app/grids/help/grids-custom-app-api).
