...
- **Buchhandlung:** Beginne bei den Bestellungen und ergänze Positionen direkt bei der Bestellung. Katalog und Kunden haben eigene Bereiche. Der Kopf zeigt den Versandstatus; **Nächster Schritt** bietet die passende Aktion für Versand, Abholung oder Abschluss. Kurze Formulare zum Erstellen und Bearbeiten öffnen sich im Dialog. Der Versand der Bestellübersicht ist optional und ändert den Versandstatus nicht. Prüfe vorher die gespeicherten Verkaufspreise; spätere Katalogänderungen ändern weder diese Preise noch vorhandene Dokumente.
...
- **Inventar:** Ausleihende wählen mehrere Sets und Einzelgeräte in einer Anfrage und verfolgen ihre eigenen Anfragen. Mindestens ein Set oder Einzelgerät ist erforderlich. Das Team gibt Einzelgeräte ausdrücklich für den Katalog frei und nutzt eine separate Ausleihverwaltung für Vorbereitung, Übergabe und Rücknahme. Die tatsächliche Ausgabe startet die Ausleihe; der Vereinbarungsversand ist optional. Rückgaben lassen sich auch ohne Scanner über die Detailseite erfassen.
