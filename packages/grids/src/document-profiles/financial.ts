...
export const financialQueryProfiles: readonly DocumentProfile[] = [
  {
    ...
    rendererVersion: "stdlib-0.26.0-datev-700-13",
    validatorVersion: "stdlib-0.26.0-datev-700-13",
  ...
  },
  {
    ...
    rendererVersion: "stdlib-0.26.0-sepa-pain-001-001-09",
    validatorVersion: `stdlib-0.26.0-dk-gbic-5:${sepaSchemaSha256}`,
