...
const authoringMessages = i18n.define({
  ...
  messages: {
    en: {
      ...
      formulaUnsupported: ({ detail }: { detail: string }) => `This formula cannot be calculated consistently: ${detail}`,
    ...
    de: {
      ...
      formulaUnsupported: ({ detail }) => `Diese Formel kann nicht einheitlich berechnet werden: ${detail}`,
