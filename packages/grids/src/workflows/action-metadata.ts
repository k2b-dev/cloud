            ...
            },
            {
              ...
              properties: {
                kind: {
                  ...
                  enum: ["zip"],
                  description:
                    "ZIP of stored Document files: the original bytes of every issued Document for the selected records, plus included Documents from earlier steps. At most 10,000 files and 512 MiB; the selection is frozen with the first attempt.",
                },
                files: {
                  kind: "array",
                  optional: true,
                  maxItems: 20,
                  description:
                    "File selections from the captured data. Omit column to use the captured rows themselves (single-table row query).",
                  items: {
                    kind: "object",
                    properties: {
                      column: {
                        ...
                        minLength: 1,
                        maxLength: 200,
                        description: "Relation column alias of the captured query; its records supply the files.",
                      },
                      template: {
                        kind: "string",
                        optional: true,
                        minLength: 1,
                        maxLength: 200,
                        description: "Only Documents of this record template (exact name or public ID).",
                      },
                      mediaType: {
                        kind: "string",
                        optional: true,
                        maxLength: 255,
                        description: "Only artifacts of this media type, for example application/pdf.",
                      },
                      required: {
                        kind: "boolean",
                        optional: true,
                        description:
                          "Default true: every selected record must contribute at least one file; rows without a relation record fail.",
                      },
                      folder: { kind: "string", optional: true, minLength: 1, maxLength: 64, description: "Folder inside the archive." },
                    },
                  },
                },
                include: {
                  ...
                  optional: true,
                  maxItems: 50,
                  items: { kind: "string", minLength: 1, maxLength: 500 },
                  description: "Documents generated by earlier steps in this run; all their artifacts are added.",
                },
              },
            },
            {
