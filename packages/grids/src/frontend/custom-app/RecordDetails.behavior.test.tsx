...
domTest("opening a draft preview loads immediately and closing aborts without an error dialog", async () => {
  ...
  try {
    ...
    Object.defineProperty(click, "currentTarget", { value: open });
    const handler = (open as HTMLButtonElement & { $$click?: (event: MouseEvent) => void }).$$click;
