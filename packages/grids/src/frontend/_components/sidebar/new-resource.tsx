import { Button, dialogCore, PanelDialog, panelDialogOptions, prompts, Select, useLocale } from "@k2b/ui";
...
export function createNewResource(props: Props) {
