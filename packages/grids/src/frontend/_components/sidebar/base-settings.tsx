import { dialogCore, panelDialogWideOptions, prompts, useLocale } from "@k2b/ui";
...
export function createBaseSettings(props: { base: Base; navigationResources: NavigationResource[] }) {
