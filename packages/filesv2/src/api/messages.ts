const messages: Record<string, [string, string]> = {
  ...
  preview_busy: ["Other previews are being generated. Try again shortly.", "Andere Vorschauen werden gerade erstellt. Bitte gleich erneut versuchen."],
  binding_changed: ["The storage binding changed. Check the original storage before retrying.", "Die Ablagenzuordnung hat sich geändert. Prüfe vor dem Wiederholen die ursprüngliche Ablage."],
  operation_unresolved: ["The operation's outcome is not confirmed. Review the current files before retrying.", "Das Ergebnis des Vorgangs ist noch unklar. Prüfe vor dem Wiederholen den aktuellen Dateibestand."],
  restore_destination_required: ["Choose a restore destination; the original path is unknown.", "Wähle ein Wiederherstellungsziel; der ursprüngliche Pfad ist unbekannt."],
