...
export function Editor(props: {
  ...
  return (<div class="kit-code" onPointerDown={() => { group = ""; }} onFocusOut={() => { group = ""; }} onKeyDown={event => {
   ...
   <AutocompleteEditor aria-label={props.path} value={props.content} textareaRef={element => {
      textarea = element;
      ...
      known = text;
      props.onChange(text);
    }} highlight={highlight.presets.code} fill spellcheck={false} variant="paper"/>
  </div>);
}
