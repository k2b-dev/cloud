    ...
    translations: {
      de: {
        ...
        adminLinks: {
          ...
          "/admin/observability/capabilities": "Capabilities",
  ...
  adminNav: [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/admin/observability/capabilities", icon: "ti-plug-connected", label: "Capabilities" },
        ...
        { href: "/admin/observability/nats", icon: "ti-server", label: "NATS" },
