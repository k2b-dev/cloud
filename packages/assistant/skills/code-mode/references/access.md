...
Studio Apps support users, groups, and the explicit `{type:"authenticated"}`
recipient. They do not support public or service-account grants. Never replace
an unavailable recipient with a broader one. The last manager cannot be removed.
