...
export const secretDialogMessages = i18n.define({
  baseLocale: "en",
  messages: {
    en: {
      cancel: "Cancel",
      add: "Add secret",
      help: "Personal to you in this chat or app. Values are encrypted and never loaded again.",
      ...
      apiKey: "API key",
      custom: "Custom",
      customPrefix: "Exact header prefix",
      scopeChat: "This chat",
      scopeApp: "This app",
    },
    de: {
      ...
      help: "Persönlich für dich in diesem Chat oder dieser App. Werte werden verschlüsselt gespeichert und nie wieder geladen.",
      ...
      header:
        "Gib einen gültigen Authentifizierungs-Header ein, z. B. Authorization oder X-API-Key. Reservierte Header wie Cookie sind nicht erlaubt.",
      ...
      customPrefix: "Exaktes Header-Präfix",
      scopeChat: "Dieser Chat",
      scopeApp: "Diese App",
    },
  },
});
