...
const template = { key: "assistant:code-mode", version: 25, ...document, instructions, references };
...
import type { AiSkillTemplate } from "./skills";
export const ASSISTANT_DATA_ANALYSIS_SKILL = ${JSON.stringify({ key: "assistant:data-analysis", version: 1, ...analysis }, null, 2)} satisfies AiSkillTemplate;
`;
