...
const template = { key: "assistant:code-mode", version: 26, ...document, instructions, references };
...
import type { AiSkillTemplate } from "./skills";
export const ASSISTANT_DATA_ANALYSIS_SKILL = ${JSON.stringify({ key: "assistant:data-analysis", version: 2, ...analysis }, null, 2)} satisfies AiSkillTemplate;
`;
