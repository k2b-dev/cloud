...
export const authMessages = i18n.define({
  ...
  messages: {
    en: {
      ...
      consentDescription: "Please review and accept the terms for this Cloud. You only need to do this once.",
      consentPrivacyJoin: "and have read the",
      consentPrivacyEnd: ".",
      consentContinue: "Accept and continue",
      consentCancel: "Cancel and sign out",
      consentFailed: "Could not save your choice. Please try again.",
      consentChanged: "The documents have changed. Reload this page and review them again.",
      consentReload: "Reload documents",
      ...
      continueWithPasskey: "Use passkey",
    ...
    de: {
      ...
      consentDescription: "Bitte prüfe und bestätige die Nutzungsbedingungen dieser Cloud. Dieser Schritt ist nur einmal nötig.",
      consentPrivacyJoin: "und habe die",
      consentPrivacyEnd: " gelesen.",
      consentContinue: "Bestätigen und zur Cloud",
      consentCancel: "Abbrechen und abmelden",
      consentFailed: "Deine Auswahl konnte nicht gespeichert werden. Bitte versuche es erneut.",
      consentChanged: "Die Dokumente wurden geändert. Lade die Seite neu und prüfe sie erneut.",
      consentReload: "Dokumente neu laden",
      ...
      continueWithPasskey: "Mit Passkey",
