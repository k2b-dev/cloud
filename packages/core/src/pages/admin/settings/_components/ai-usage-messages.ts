...
export const aiUsageMessages = i18n.define({
  ...
  messages: {
    en: {
      ...
      comparisonsTab: "Users & models",
      runsTab: "Errors & runs",
      views: "Usage views",
      all: "All",
      unassigned: "Unassigned",
      filterLoadFailed: "Could not load filter values.",
      sort: "Sort by",
      negativeRate: "Negative share",
      negativeFeedback: "Negative feedback",
      negative: "negative",
      positive: "positive",
      feedbackCoverage: "Response rating coverage",
      measured: "with reported data",
      ...
      noStoredError: "No error text was stored.",
      runId: "Run ID",
      ...
      ratingUpdated: "Rating last updated",
    ...
    de: {
      ...
      comparisonsTab: "Nutzer & Modelle",
      runsTab: "Fehler & Läufe",
      views: "Nutzungsansichten",
      all: "Alle",
      unassigned: "Nicht zugeordnet",
      filterLoadFailed: "Filterwerte konnten nicht geladen werden.",
      sort: "Sortieren nach",
      negativeRate: "Negativanteil",
      negativeFeedback: "Negatives Feedback",
      negative: "negativ",
      positive: "positiv",
      feedbackCoverage: "Bewertungsabdeckung",
      measured: "mit gemeldeten Daten",
      ...
      running: "Läuft",
      waiting: "Wartet",
      error: "Gespeicherter Fehler",
      errorCode: "Fehlercode",
      noStoredError: "Es wurde kein Fehlertext gespeichert.",
      runId: "Lauf-ID",
      conversationId: "Chat-ID",
      turnId: "Durchlauf-ID",
      workflowRunId: "Workflow-Lauf-ID",
      traceId: "Trace-ID",
      attempts: "Versuche",
      comment: "Kommentar",
      messageId: "Nachrichten-ID",
      responseCreated: "Antwort erstellt",
      ratingUpdated: "Bewertung zuletzt geändert",
      ...
      showUnassigned: "Nicht zugeordnete anzeigen",
      periodHelp:
