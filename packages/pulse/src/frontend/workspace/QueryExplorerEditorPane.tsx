import { AutocompleteEditor, Button, type Completion, TextInput } from "@k2b/ui";
  ...
  return (
    <div class="grid grid-cols-[4.75rem_minmax(0,1fr)] items-start gap-2">
      <div
        ...
        title={`${props.group.key} · ${t().variantCount({ count: props.group.count })}`}
      >
        {props.group.key}
      </div>
      <div class="flex flex-wrap gap-2">
...
const SuggestedRefinementRows = (
  ...
  return (
    <div class="mt-3 space-y-2">
      ...
      <Show
        when={
          props.suggestionsExpanded() && props.suggestionMatches().sources.length === 0 && props.suggestionMatches().labels.length === 0
        }
      >
