...
- **Use Inventory as the lookup table:** Open Reference, then choose Inventory. Filter the live catalog by source or resource, inspect observed field roles, then copy scoped snippets into Query explorer or Dashboard DSL.
