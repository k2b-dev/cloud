...
export const linuxAccountMessages = i18n.define({
  ...
  messages: {
    en: {
      ...
      managedLocal: "Managed by Cloud. Numeric IDs stay fixed, including after disabling preparation.",
      disabled: "Local identity preparation is disabled. Existing values are retained.",
      ...
      guest: "Guest accounts cannot be prepared for Linux. Any earlier identity remains reserved and does not grant access.",
      uid: "Numeric user ID",
      gid: "Primary group ID",
      home: "Home directory",
      shell: "Login shell",
      missing: "Not supplied",
      prepare: "Prepare Linux identity",
      ...
      group_conflict: "A group already uses this name. Resolve the name conflict before preparing the identity.",
      ...
      setup_disabled: "Local identity preparation has been disabled. Refresh the page.",
    ...
    de: {
      ...
      managedLocal: "Durch Cloud verwaltet. Numerische IDs bleiben fest, auch nach Deaktivierung der Vorbereitung.",
      disabled: "Die Vorbereitung lokaler Identitäten ist deaktiviert. Bestehende Werte bleiben erhalten.",
      ...
      guest: "Gastkonten können nicht für Linux vorbereitet werden. Eine frühere Identität bleibt reserviert und gewährt keinen Zugang.",
      uid: "Numerische Benutzer-ID",
      gid: "Primäre Gruppen-ID",
      home: "Home-Verzeichnis",
      shell: "Login-Shell",
      missing: "Nicht geliefert",
      prepare: "Linux-Identität vorbereiten",
      ...
      group_conflict: "Eine Gruppe verwendet diesen Namen bereits. Behebe den Namenskonflikt vor der Vorbereitung.",
      ipa_inventory_unavailable:
      ...
      setup_disabled: "Die Vorbereitung lokaler Identitäten wurde deaktiviert. Aktualisiere die Seite.",
