...
description: Öffentliche FAQ-Einträge, Zielgruppen, Markdown-Antworten und Administration.
order: 100
---

FAQ veröffentlicht kurze Antworten für die aktuelle Person. Öffne eine Frage in der FAQ-Übersicht, um ihre Antwort anzuzeigen. Du musst vorher keinen anderen Eintrag auswählen.
...
## Eine Antwort finden {icon="search"}

- Suche in den sichtbaren Fragen nach der Aufgabe oder dem Problem, das du wiedererkennst.
