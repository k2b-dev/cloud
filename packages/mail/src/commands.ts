...
export const mailCommandMessages = i18n.define({
  ...
  messages: {
    en: {
      ...
      searchTitle: "Search all mail",
      searchDescription: "Find conversations across your accessible mailboxes.",
      mail: "Mail",
    ...
    de: {
      ...
      searchTitle: "Alle E-Mails durchsuchen",
      searchDescription: "Konversationen in deinen zugänglichen Postfächern finden.",
      mail: "Mail",
