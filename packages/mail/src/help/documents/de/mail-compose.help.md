...
Wird der Entwurf zusätzlich in den Entwürfe-Ordner des Anbieters synchronisiert und dort in einem anderen E-Mail-Programm bearbeitet, behält Mail seine eigene Fassung, sobald der zurückkommende Text nicht aufgelöste Platzhalter enthält, und bietet die externe Fassung als Wiederherstellungskopie an.
