...
describe("Capability v2 provider conformance", () => {
  ...
  test("required-idempotency Actions remain an explicit inventory", () => {
    ...
    expect(required).toEqual([
      ...
      "mail.draft.attachment.add",
      "mail.draft.attachment.remove",
      "mail.draft.create",
      "mail.draft.discard",
      "mail.draft.send",
      "mail.mailbox.tag.create",
      "mail.mailbox.tag.delete",
      "mail.mailing-list.unsubscribe",
      "notebooks.comment.create",
      "notebooks.comment.delete",
      "notebooks.note.create",
      "spaces.comment.create",
      "spaces.comment.delete",
